...
public class AddEntryToCatalog {
  ...
  public void testAddEntryToCatalog() throws Exception {
    ...
    AddNewContact();
    FillFormCatalog(new ContactData("Olga", "Vladimirovna", "Uscelemova", "Olga", "BBB", "Riga", "22233355", "lena-usc@inbox.lv", "28", "April", "1978", "Riga", "test1", "Riga", "catalog entry2"));
    submitForm();
    GoToHome();
    logout();
  }
  ...
  private void FillFormCatalog(ContactData contactData) {
